        ...
        if (CurrentModeAffiche == ModeJeuAffiche.GUI) {
            if (CurrentModePlay == ModeJeuPlay.PVP) {
                ...
                switch (couleur) {
                    case 'B':
                        System.out.println("Mouvement " + couleur);
                        mvtIa = Profiler.analyse(this::jouerIA2, couleur);
                        src = mvtIa[0];
                        dst = mvtIa[1];
                        System.out.println(src + "->" + dst);
                        coup.add(couleur + "," + src + "," + dst + "," + deplace(couleur, src, dst, ModeMvt.SIMU));
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            if (n == 1) {
                ...
                switch (ModeJeuPlayValue) {
                    ...
                    case 3:
                        ...
                        break;
                        default: jeu.CurrentModeAffiche = ModeJeuAffiche.CONSOLE;
            ...
            switch (ModeJeuPlayValue) {
                ...
                case 3:
                    jeu.CurrentModePlay = ModeJeuPlay.IAVIA2;
                    break;
                default: jeu.CurrentModePlay = ModeJeuPlay.PVIA2;
            }
        ...
        switch (ModeJeuSaveValue) {
            ...
            case 1:
                ...
                break;
            default: jeu.CurrentModeSave = ModeJeuSave.NO;
        }
